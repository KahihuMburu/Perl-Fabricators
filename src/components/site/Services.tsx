        ...
        <div className="grid grid-cols-1 gap-px bg-border sm:grid-cols-2 lg:grid-cols-3">
          {services.map((s, i) => (
            <motion.div
              ...
              className="group relative bg-card p-8 transition-colors hover:bg-secondary md:p-10"
            >
              <div className="mb-6 inline-flex h-14 w-14 items-center justify-center bg-background text-primary transition-colors group-hover:bg-primary group-hover:text-primary-foreground">
