    ...
    <section id="top" className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col justify-end container-px pb-20 pt-32">
        <motion.div
          ...
          className="max-w-4xl"
        >
          <div className="mb-6 inline-flex items-center gap-2 border border-primary/40 bg-primary/10 px-3 py-1.5 text-xs font-medium uppercase tracking-[0.2em] text-primary backdrop-blur">
            <span className="h-1.5 w-1.5 rounded-full bg-primary" />
            Ruiru · Kiambu County · Kenya
          </div>

          <h1 className="font-display text-5xl font-bold leading-[0.95] tracking-tight text-foreground sm:text-6xl md:text-7xl lg:text-8xl text-balance">
            Precision Steel.
            <br />
            <span className="text-primary">Reliable</span> Construction.
          </h1>
